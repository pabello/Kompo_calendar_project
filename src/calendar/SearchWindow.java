...
public class SearchWindow extends JFrame{
	...
	public SearchWindow(EventList eventList){
        ...
        search.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0), "closeWindow");
        search.getActionMap().put("closeWindow", new CloseWindowAction(this));
